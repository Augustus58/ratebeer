...
describe "Beerlist page" do
  ...
  it "shows beers in alphabetical order by style when style clicked", js:true do
    visit beerlist_path
    click_link "Style"
  ...
  it "shows beers in alphabetical order by brewery when brewery clicked", js:true do
    visit beerlist_path
    click_link "Brewery"
